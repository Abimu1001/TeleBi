...
<main role="main" class="container">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card mb-3">
				<div class="card-header"  style="background: #68D8D6;">
				...
				<div class="card-footer"  style="background: #9CEAEF;">
					<a href="<?= base_url('/checkout') ?>" class="btn btn-outline-black float-right text-black">Pembayaran <i class="fas fa-angle-right"></i></a>
					<a href="<?= base_url('/') ?>" class="btn btn-outline-black text-black"><i class="fas fa-angle-left"></i> Kembali Belanja</a>
				</div>
			</div>
		</div>
	</div>
