	...
	<div class="row">
		<div class="col-md-10 mx-auto">
			<div class="card mb-3">
				...
				<strong><span>Produk</span></strong>
						...
						<form action="<?= base_url("product/search") ?>" method="POST">
							<div class="input-group">
								...
								<div class="input-group-append">
									...
									<a href="<?= base_url("product/reset") ?>" class="btn btn-outline-dark btn-sm">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<span class="badge bg-outline-primary"><i class="fas fa-tags"></i> <?= $row->category_title ?></span>
								</td>
