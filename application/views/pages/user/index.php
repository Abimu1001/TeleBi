		...
		<div class="col-md-10 mx-auto">
			<div class="card mb-3">
				<div class="card-header" style="background-color: #68D8D6;">
					<span><strong>Pengguna</strong></span>
					<a href="<?= base_url('user/create') ?>" class="btn btn-sm btn-outline-dark">Tambah</a>
						...
						<form action="<?= base_url("user/search") ?>" method="POST">
							<div class="input-group">
								...
								<div class="input-group-append">
									...
									<a href="<?= base_url("user/reset") ?>" class="btn btn-outline-dark btn-sm">
